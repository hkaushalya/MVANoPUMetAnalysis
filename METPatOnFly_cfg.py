...
#options.register ('GT','START53_V7L::All',#GR_R_52_V9::All
options.register ('GT','POSTLS171_V1::All',   #ttbar postls171 fullsim
#options.register ('GT','POSTLS171_V1_FastSim::All',   #ttbar postls171 fastsim
          VarParsing.VarParsing.multiplicity.singleton,
          VarParsing.VarParsing.varType.string,
          "Global Tag")
...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('/store/relval/CMSSW_5_3_9_patch3/RelValH130GGgluonfusion/GEN-SIM-RECO/PU_START53_V7L_PhRdPu_24Apr2013-v1/00000/3EBDFCA0-CFAD-E211-AC68-0025905964C2.root')
    #fileNames = cms.untracked.vstring('/store/relval/CMSSW_5_3_9_patch3/RelValZEE/GEN-SIM-RECO/PU_RD53_V0B_PuDbIov3Runs-v1/00000/24A00639-A2A2-E211-B832-0025901A9FE0.root')
    ...
    fileNames = cms.untracked.vstring('/store/relval/CMSSW_7_1_0_pre5/RelValTTbar_13/GEN-SIM-RECO/POSTLS171_V1-v1/00000/66797485-44B6-E311-9924-002618943939.root')

	 	#715 fastsim
    #fileNames = cms.untracked.vstring('/store/relval/CMSSW_7_1_0_pre5/RelValTTbar_13/GEN-SIM-RECO/POSTLS171_V1-v1/00000/66797485-44B6-E311-9924-002618943939.root')
#    fileNames = cms.untracked.vstring('/store/relval/CMSSW_7_1_0_pre5/RelValTTbar_13/GEN-SIM-DIGI-RECO/POSTLS171_V1_FastSim-v1/00000/00647133-EDB5-E311-8D22-0025905A60B4.root')
)
...
# do not need this for MC validations
...
if options.mode.lower()=='mc':
  ...
  print "\nFilter List:", "HLT, scraping, PV, trackingFailureFilter, hcalLaser, CSCTightHalo, eeBadSC, EcalTP\n"
...
if options.mode.lower()=='data':
  ...
  print "\nFilter List:", "HLT, scraping, PV, trackingFailureFilter, hcalLaser, CSCTightHalo, eeBadSC, EcalTP, hcalLaser2012, ecalLaserCorr\n"
